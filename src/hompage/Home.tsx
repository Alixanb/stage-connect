  ...
  return (
    <Layout>
      <Helmet>
        ...
        <meta name="description" content="Plongez dans l'expérience immersive de Connect Stage. Assistez à des concerts virtuels en 3D, intéragissez et vivez l'événement comme si vous y étiez réellement." />
